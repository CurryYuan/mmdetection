...
class MyCascadeRCNN(BaseDetector, RPNTestMixin):
    ...
    def __init__(self,
        ...
        super(MyCascadeRCNN, self).__init__()

        self.rpn_stages = rpn_stages
    ...
    def init_weights(self, pretrained=None):
        super(MyCascadeRCNN, self).init_weights(pretrained)
    ...
    def show_result(self, data, result, img_norm_cfg, **kwargs):
        ...
        super(MyCascadeRCNN, self).show_result(data, result, img_norm_cfg,
                                             **kwargs)
